...
class AzureMLFlowTrainer:
    def __init__(self,model_params:dict,data_path:str) -> None:
    ...
    def load_dataset(self):
        ...
        iris_df = pd.read_csv(self.data_path)
        return iris_df
...
if __name__ == "__main__":
    ...
    data_path = args.data
    mlflow_processor = AzureMLFlowTrainer(data_path=data_path,model_params=model_params)
